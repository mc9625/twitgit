                ...
                html.Div(
                    [
                        html.A(
                            ...
                            href='https://nuvolaproject.cloud',
                            target='_blank',
                            className="app__header__title"
                        ),
                        html.P(
                            "This app streams tweets about the ONU 2030 Goals  in real time and displays live charts for topic tracking and sentiment analysis.",
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.P(
                            "The keywords tracked by the streaming server includes: #sustainabledevelopmentgoals, #onu2030'and #2030objectives",
